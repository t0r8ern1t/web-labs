...
<form action="2a.php" method="post">
    ...
    <a href="index2b.php">Go to index_2_2</a> # Сохраняем ссылку на index_2, где выводим данные из session
    <br>
</form>
# 2.C <br>
<form action="2c.php" method="post">
    ...
    <button class="my_button">Save to session</button><br>
    <a href="index2c.php">Go to index_2_3</a>
    <br>
</form>
# 3 <br>
<div id="form">
...
<div id="table">
    <table>
        ...
        $spreadsheetId = '1S83Tj7rEU40_KCJ8Vl_I_Lbg2co6jmwwmc5l5wmSFYc';
